...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center max-w-[1240px] mx-auto md:px-12 px-4'>
      ...
      <ul className='hidden md:flex'>
        <li className='p-3'><Link to="/nosotros" className='lg:text-xl md:text-lg sm:text-base cursor-pointer hover:underline hover:text-custom-264948 hover:font-medium'>Sobre Nosotros</Link></li>
        <li className='p-3'><Link to="/servicio" className='lg:text-xl md:text-lg sm:text-base cursor-pointer hover:underline hover:text-custom-264948 hover:font-medium'>Nuestro Servicios</Link></li>
        <li className='p-3'><Link to="/producto" className='lg:text-xl md:text-lg sm:text-base cursor-pointer hover:underline hover:text-custom-264948 hover:font-medium'>Productos</Link></li>
      </ul>
