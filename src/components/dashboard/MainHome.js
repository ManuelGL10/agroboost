    ...
    <div className={`${darkMode && "dark"}`}>
        <div className='bg-background dark:bg-[#1B2431] p-4 mt-16'>
            ...
            <div className='py-4 grid lg:grid-cols-4 lg:gap-x-4 grid-cols-2 gap-2 md:gap-2 md:grid-cols-4 justify-between dark:text-white'>
                <div className='p-3 bg-white dark:bg-[#273142] rounded-lg'>
                    <div className='flex items-center h-height-full justify-between'>
                        <div className='grid gap-2 col-span-3'>
                            <span className='lg:text-lg text-md font-medium text-gray-600 dark:text-gray-300'>Usuarios Totales</span>
                            <span className='lg:text-2xl text-xl font-bold'>{usersCount}</span>
                        </div>
                        <div className='flex items-center justify-center rounded-2xl bg-[#8280FF] size-12'>
                            <IconUsers className='lg:size-8 md:size-8 size-6' color='white' />
                        </div>
                    </div>
                </div>
                <div className='p-3 bg-white dark:bg-[#273142] rounded-lg'>
                    <div className='flex items-center h-height-full justify-between'>
                        <div className='grid gap-2 col-span-3 h-height-full'>
                        ...
                        <div className='flex items-center justify-center rounded-2xl bg-[#FEC53D] size-12'>
                            <IconShoppingCart className='lg:size-8 md:size-8 size-6' color='white' />
                        </div>
                    </div>
                </div>
                <div className='p-3 bg-white dark:bg-[#273142] rounded-lg'>
                    <div className='flex items-center h-height-full justify-between'>
                        ...
                        <div className='flex items-center justify-center rounded-2xl bg-[#4AD991] size-12'>
                            <IconTrendingUp className='lg:size-8 md:size-8 size-6' color='white' />
                        </div>
                    </div>
                </div>
                <div className='p-3 bg-white dark:bg-[#273142] rounded-lg'>
                    <div className='flex items-center h-height-full justify-between'>
                        ...
                        <div className='flex items-center justify-center rounded-2xl bg-[#FF9066] size-12'>
                            <IconClockStop className='lg:size-8 md:size-8 size-6' color='white' />
                        </div>
                    </div>
                </div>
            </div>
