...
import { IconUsers, IconTrendingUp, IconBox, IconClockStop } from '@tabler/icons-react'
        ...
        <div className='py-4 flex justify-between'>
            <div className='p-4 bg-white rounded-lg'>
                <div className='flex items-center'>
                    ...
                    <div className='flex items-center justify-center rounded-2xl bg-[#8280FF] w-14 h-14 ml-4'>
            ...
            <div className='p-4 bg-white rounded-lg'>
                <div className='flex items-center'>
                    ...
                    <div className='flex items-center justify-center rounded-2xl bg-[#FEC53D] w-14 h-14 ml-4'>
                        <IconBox size={32} color='white' />
                    </div>
                </div>
                <div className='flex mt-4 items-center'>
                    <IconTrendingUp color='#66bc8a' />
            ...
            <div className='p-4 bg-white rounded-lg'>
                <div className='flex items-center'>
                    ...
                    <div className='flex items-center justify-center rounded-2xl bg-[#4AD991] w-14 h-14 ml-4'>
                        <IconTrendingUp size={32} color='#D33363' />
                    </div>
                </div>
                <div className='flex mt-4 items-center'>
                    <IconTrendingUp color='#66bc8a' />
            ...
            <div className='p-4 bg-white rounded-lg'>
                <div className='flex items-center'>
                    ...
                    <div className='flex items-center justify-center rounded-2xl bg-[#FF9066] w-14 h-14 ml-4'>
                        <IconClockStop size={32} color='white' />
                    </div>
                </div>
                <div className='flex mt-4 items-center'>
                    <IconTrendingUp color='#66bc8a' />
