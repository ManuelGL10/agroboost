...
const Footer = () => {
  return (
    <div className='bg-custom-204E51 mx-auto md:px-12 px-4 p-2'>
      <div className='flex my-2 max-w-[1545px] mx-auto md:px-12 px-4 p-2'>
        <div>
      ...
      <div className='justify-center text-center text-white border-t-2 mt-10 max-w-[1545px] mx-auto md:px-12 px-4 p-2'>
        <div>
