...
import ImgAlerta from '../../img/cancelar.png'
    ...
    <>
      ...
      <div className={`fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none ${isOpen ? 'block' : 'hidden'}`}>
        <div className="relative w-full max-w-md p-6 bg-white rounded-lg shadow-lg">
          ...
          <h3 className="text-lg block font-medium text-[#D33363] md:text-3xl sm:text-2xl text-1xl mt-5 mb-7 text-center">¡ALTO, ESPERA UN MOMENTO!</h3>
